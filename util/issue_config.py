...
class Issue_Config:
    ...
    ISSUE_TECH_STACK_WEBSERVER = config["Tech Stack"]["ISSUE_TECH_STACK_WEBSERVER"]
    ISSUE_TECH_STACK_X_POWERED_BY = config["Tech Stack"]["ISSUE_TECH_STACK_X_POWERED_BY"]
    ISSUE_TECH_STACK_CMS = config["Tech Stack"]["ISSUE_TECH_STACK_CMS"]
    ISSUE_TECH_STACK_JS_FRAMEWORK = config["Tech Stack"]["ISSUE_TECH_STACK_JS_FRAMEWORK"]
    ISSUE_TECH_STACK_JS_FRAMEWORK_VER = config["Tech Stack"]["ISSUE_TECH_STACK_JS_FRAMEWORK_VER"]
    ISSUE_TECH_STACK_CDN = config["Tech Stack"]["ISSUE_TECH_STACK_CDN"]
    ISSUE_TECH_STACK_SECURITY = config["Tech Stack"]["ISSUE_TECH_STACK_SECURITY"]

    SUGGESTION_TECH_STACK_WEBSERVER = config["Tech Stack"]["SUGGESTION_TECH_STACK_WEBSERVER"]
    SUGGESTION_TECH_STACK_X_POWERED_BY = config["Tech Stack"]["SUGGESTION_TECH_STACK_X_POWERED_BY"]
    SUGGESTION_TECH_STACK_CMS = config["Tech Stack"]["SUGGESTION_TECH_STACK_CMS"]
    SUGGESTION_TECH_STACK_JS_FRAMEWORK = config["Tech Stack"]["SUGGESTION_TECH_STACK_JS_FRAMEWORK"]
    SUGGESTION_TECH_STACK_JS_FRAMEWORK_VER = config["Tech Stack"]["SUGGESTION_TECH_STACK_JS_FRAMEWORK_VER"]
